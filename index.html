...
<body>
  ...
  <div class="instruction" id="instruction">Clique sur l'enveloppe pour l'ouvrir 💌</div>
    ...
    <div class="envelope" id="envelope">
      ...
      <div class="letter">
        ...
        <div class="letter-preview">
          <h2 id="prev-title">Joyeux Anniversaire !</h2>
          <p id="prev-body">À mon précieux Kaka Nini, qu'en ce 29 septembre ton cœur soit rempli de bonheur...</p>
        </div>
  ...
  <div class="modal-overlay" id="modalOverlay" onclick="closeModalOnOverlay(event)">
    <div class="modal-card">
      ...
      <div class="modal-body">
        <h2 id="modal-title">Joyeux Anniversaire !</h2>
        <div class="subtitle">Pour mon amour, Kaka Nini ❤️</div>
        ...
        <div class="signature" id="modal-signature">Ton amour ❤️</div>
      </div>
    </div>
  </div>

  <!-- Modal d'édition du texte -->
  <div class="modal-overlay" id="editModalOverlay">
    <div class="modal-card">
      <button class="close-modal" onclick="closeEditModal()">&times;</button>
      <h3 style="margin-bottom: 15px; font-family: 'Montserrat', sans-serif;">Personnaliser le message</h3>
      
      <label style="font-size: 0.8rem; display:block; margin-bottom: 5px;">Titre :</label>
      <input type="text" id="edit-title" class="edit-field" value="Joyeux Anniversaire !">

      <label style="font-size: 0.8rem; display:block; margin-bottom: 5px;">Surnom / Sous-titre :</label>
      <input type="text" id="edit-subtitle" class="edit-field" value="Pour mon amour, Kaka Nini ❤️">

      <label style="font-size: 0.8rem; display:block; margin-bottom: 5px;">Message :</label>
      <textarea id="edit-body" class="edit-field"></textarea>

      <label style="font-size: 0.8rem; display:block; margin-bottom: 5px;">Signature :</label>
      <input type="text" id="edit-signature" class="edit-field" value="Ton amour ❤️">

      <button class="btn btn-primary" style="width: 100%; justify-content: center; margin-top: 10px;" onclick="saveCustomText()">
  ...
  <script>
    ...
    function toggleEnvelope() {
      ...
      if (isOpen) {
        ...
        instruction.textContent = "Clique sur l'enveloppe pour l'ouvrir 💌";
      }
    }
    ...
    function openEditModal() {
      ...
      document.getElementById('edit-body').value = document.getElementById('modal-body-text').innerText.trim();
    ...
    function saveCustomText() {
      ...
      document.getElementById('prev-body').innerText = body;

      // Mettre à jour le modal plein écran
      document.getElementById('modal-title').innerText = title;
      document.querySelector('.modal-body .subtitle').innerText = subtitle;
      document.getElementById('modal-body-text').innerText = body;
      document.getElementById('modal-signature').innerText = signature;
